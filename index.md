...
<div class="layout">
  ...
  <main class="content">
    <div class="header-grid">
      <div class="card">
        <div class="profile">
            <img src="assets/images/profile.jpg" alt="Hyunmin Jeon" class="avatar"/>
            <div>
            <h1 style="margin-bottom:6px;">
                전현민 <span style="color:var(--muted); font-weight:600;">(Hyunmin Jeon)</span>
            </h1>
            <div class="badges">
                <span class="badge">AI & NLP Engineer</span>
        ...
        <div class="kpi" style="margin-top:14px;">
          <div class="box">
            ...
            <div class="value">July 11, 1995</div>
          </div>
          <div class="box">
            <div class="label">Location</div>
            <div class="value">Seoul, Republic of Korea</div>
          </div>
        </div>
      </div>
      <div class="card">
    ...
    <div class="two-col">
      <div class="item">
        ...
        <br>
        <div class="stack">
          <span>LLM</span><span>RAG</span><span>Prompt Engineering</span>
          <span>Generative Agent</span><span>Multi-Agent Orchestration</span>
          <span>Knowledge Graph</span><span>Graph RAG</span>
          <span>NLP</span><span>Task-oriented Dialogue System</span>
          <span>MCP</span>
        </div>
      </div>
      <div class="item">
        <div class="top">
          <div class="role">Language / Library / Framework</div>
        </div>
        <br>
        <div class="stack">
          <span>Python</span>
      ...
      <div class="item">
        <div class="top">
          <div class="role">Infra / DevOps / Cloud</div>
        </div>
        <br>
        <div class="stack">
          <span>Git</span>
    ...
    <div class="card">
      <div class="item">
        <div class="top">
          <div class="role">POSTECH / M.S.</div>
          <div class="meta">2019.09 ~ 2021.08</div>
        </div>
        <div class="pills">
      ...
      <div class="item">
        <div class="top">
          <div class="role">Hanyang University ERICA / B.S.</div>
          <div class="meta">2014.03 ~ 2019.08</div>
        </div>
        <div class="pills">
          <em>Computer Science & Engineering</em>
          <em>GPA 4.27 / 4.5</em>
    ...
    <div class="card">
      <div class="item">
        <div class="top">
          <div class="role">넷마블 / AI & NLP Engineer</div>
          <div class="meta">2023.12 ~ Current</div>
        </div>
        <div class="pills">
      ...
      <div class="item">
        <div class="top">
          <div class="role">컴투스플랫폼 / AI & NLP Engineer</div>
          <div class="meta">2021.09 ~ 2023.11</div>
        </div>
        <div class="pills">
      ...
      <div class="item">
        <div class="top">
          <div class="role">와이즈넛 / Intern</div>
          <div class="meta">2019.01 ~ 2019.02</div>
        </div>
        <div class="pills">
    ...
    <div class="card">
      ...
      <div class="item">
        <div class="top">
          <div class="role">9th Dialog System Technology Challenge (DSTC-9)</div>
        </div>
        <div class="pills">
      ...
      <div class="item">
        ...
        <ul class="list-tight">
          ...
          <details>
            ...
            <img src="assets/images/legal_chatbot_demo.gif" alt="프로토타입 데모 영상" style="max-width:100%; margin-top:12px; border:1px solid var(--border); border-radius:8px;"/>
          </details>
        </ul>
      </div>
    </div>
    ...
    <div class="card">
      <div class="item">
        <div class="top">
          <div class="role">DS-DST belief tracker 논문 구현</div>      
        </div>
        <ul class="list-tight">
      ...
      <div class="item">
        <div class="top">
          <div class="role">KoGPT-2 summarization 모델</div>      
        </div>
        <ul class="list-tight">
      ...
      <div class="item">
        <div class="top">
          <div class="role">Machine translation 모델</div>      
        </div>
        <ul class="list-tight">
      ...
      <div class="item">
        <div class="top">
          <div class="role">Sentiment analysis 모델</div>      
        </div>
        <ul class="list-tight">
      ...
      <div class="item">
        <div class="top">
          <div class="role">Machine learning 웹 크롤러</div>      
        </div>
        <ul class="list-tight">
      ...
      <div class="item">
        <div class="top">
          <div class="role">지하철 빈 자리 체크 시스템</div>      
        </div>
        <ul class="list-tight">
